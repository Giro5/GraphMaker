...
namespace GraphMaker
{
    public partial class Form1 : Form
    {
        ...
        private void BuildBtn_Click(object sender, EventArgs e)
        {
            ...
            GraphicChart.ChartAreas[0].AxisX.Minimum = -10;
            GraphicChart.ChartAreas[0].AxisX.Maximum = 10;
            GraphicChart.ChartAreas[0].AxisX.MajorGrid.Interval = 1;
            for (double i = -10; i <= 10; i += 0.1)
            {
                string txt = textBox1.Text.Replace("x", i.ToString());
                double y = Solution(txt);
                if (!double.IsNaN(y) && !double.IsInfinity(y))
                    GraphicChart.Series[0].Points.AddXY(i, y);
            }
        }
        ...
        {
            double Result = 0;
            text = string.Join(" ", text.Split(), 0, new string[] { Plus, Minus, Mul, Div, "Mod", "^", "yroot" }
            ...
            catch//решаем...
            {
                ...
                string[][] ranks = new string[][] {
                        ...
                        new string[] { Mul, Div, "Mod" },
                        new string[] { "^", "yroot" } };//создание рангов операций
        ...
        private double SolutionFunc(string text) //text is briefly func. Example: "fact(5)" will "120"
